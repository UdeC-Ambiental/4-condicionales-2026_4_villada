...
| `reto1_temperatura.ipynb` | Clasificación térmica y riesgo | Ariana Peña |
| `reto2_ph.ipynb` | Evaluación de pH y alerta química | Mariana Villada |
| `reto3_oxigeno.ipynb` | Análisis biológico por oxígeno | Juan Zamudio |
